        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse <?php echo $navbar_collapse_class; ?>" id="main-navbar-collapse">
                ...
                <div class="main-menu-wrapper">
                    ...
                    $arTranslations['search'] = array('nl'=>'Voer uw zoekterm in...', 'en'=>'Enter your search term...', 'de' => 'Enter your search term...');
                    $arTranslations['go'] = array('nl'=>'Zoek', 'en'=>'Go', 'de' => 'Go');
                    ?>
                    <!-- Header: Cart -->
                    <?php if( 1 == get_theme_mod( 'header_cart', 1 ) && in_array(ICL_LANGUAGE_CODE, $allowLang) ) { ?>
                                ...
                                <li>
                                    <form role="search" method="get" action="<?php echo home_url( '/' ); ?>">
                                        <div class="input-group">
                                          <input class="search-field" placeholder="<?php echo $arTranslations['search'][ICL_LANGUAGE_CODE]; ?>" type="text" value="" name="s" id="s">
                                          <span class="input-group-btn">
                                            <input class="header-search-submit" type="submit" value="<?php echo $arTranslations['go'][ICL_LANGUAGE_CODE]; ?>">
                                          </span>
                                        </div><!-- /input-group -->
                                    </form>
                                </li>
